        ...
        {selectedMethod === "Bank Transfer" && (
          <>
            ...
            <View className="mt-8 bg-white-normal border border-[#eeeeef] rounded-lg p-4 mx-4">
              <Text className="text-[#151A20] font-semibold text-xl mb-4 font-axiformaBlack text-center capitalize">
              ...
              {[
                ...
                >
                  ...
                  <Text className="text-[#3D4C5E]  font-axiformaRegular leading-5 capitalize">
                    {step}
                  </Text>
                </View>
              ))}
